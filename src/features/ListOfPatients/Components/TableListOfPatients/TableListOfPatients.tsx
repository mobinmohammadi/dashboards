      ...
      <table className="min-w-full border border-gray-300 border-b-[#E7E7E7] rounded-lg overflow-hidden">
        <thead className="bg-gray-100">
          <tr className="text-xs text-gray-500">
            ...
            <th className="px-4 py-3 border-b border-b-[#E7E7E7] hidden sm:table-cell">
              سن
            </th>
            <th className="px-4 py-3 border-b border-b-[#E7E7E7] hidden sm:table-cell">
              جنسیت
        ...
        <tbody className="text-sm text-gray-700">
          {patients.slice(0, 10).map((patient, index) => (
            <tr key={patient.id} className="hover:bg-gray-50  transition">
              ...
              <td className="px-4 py-3 overflow-hidden border-b truncate border-b-[#E7E7E7] whitespace-nowrap overflow-ellipsis">
                {patient.name}
              </td> 
              ...
              <td className="px-4 py-1   border-b border-b-[#E7E7E7] text-center">
                {patient.status == 1 ? (
                  <svg className="w-6 h-6 text-green-700">
                    <use href="#check-circles"></use>
                  </svg>
                ) : (
              ...
              <td className="px-4 py-3 border-b border-b-[#E7E7E7] text-center flex justify-between">
                ...
                <span></span>
                <div
                  onClick={() => navigate(`/onpateintsedit/${patient.id}`)}
                  className=" p-1 cursor-pointer rounded-full bg-primary-100 text-white"
                >
